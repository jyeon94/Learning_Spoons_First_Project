...
* 매년 유기 동물의 수가 증가하고 있고, 인터넷 뉴스에서는 유기 동물 수 증가의 원인으로 1인 가구 수의 증가를 꼽고 있다. 1인 가구가 증가하면서 반려 동물의 입양이 늘었으며 유기 또한 증가하였다는 것이다. 정부에서는 무책임한 동물 유기에 대한 방안으로 반려 동물에 대한 인식 전환을 촉구하는 한편, 동물 보호 및 복지를 위한 예산을 편성하여 유기 동물 보호소를 지원하고 입양을 권장하고 있다.
