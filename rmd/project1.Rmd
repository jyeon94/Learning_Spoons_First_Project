...
* 유기 동물 조회 서비스 시작인 2014년부터 서비스 개편 이전인 2016년까지의 데이터는 입력 기준이 ***존재하지 않음***
...
* 2018년부터 경기도에서 가장 많은 유기 동물이 발생
* 2015년~2016년 유기 동물 발생 1위 도시 서울특별시는 2019년에는 순위가 9위로 하락
...
* 유기 동물 방지를 위해서는 동물 입양 단계부터 정책이 진행되지 않는게 아쉽다.
